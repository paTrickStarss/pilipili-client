  ...
  >
    <template #trigger>
      <div
        ...
        :class="`mini-avatar--${showPop == 1 ? 'large' : showPop == 0 ? 'small' : 'init'}`"
      >
        <!--          小头像-->
        <a
        ...
        >
          <picture class="v-img">
            ...
            />
            <img
              src="//i0.hdslb.com/bfs/face/5738c58cb8a8d3717f6cd8545bd5e1eda37e17c1.jpg@120w_120h_1c"
              alt=""
              loading="lazy"
            />
          </picture>
        ...
        >
          ...
          >
            ...
            />
            <span
              class="pili-avatar-icon pili-avatar-right-icon pili-avatar-icon-big-vip pili-avatar-size-82"
            ></span>
          </div>
        </a>
      </div>
...
@keyframes avatarFadeLarge {
  0% {
    opacity: 0;
    transform: scale(0.4) translateY(-2px) translate(3px);
  }
  30% {
    opacity: 1;
  }
