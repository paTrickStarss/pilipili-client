...
.carousel .carousel-container .vui_carousel .carousel-footer .carousel-dots-dot.is-revert .before {
  animation: eat-haha-down-0d1b8730 .8s;
}
.carousel .carousel-container .vui_carousel .carousel-footer .carousel-dots-dot.is-revert .after {
  animation: eat-haha-up-0d1b8730 .8s;
}
